...
const emoji_double_slider = {
    ...
    <div style="display: flex; flex-direction: column; align-items: center; justify-content: center; width: 100%;">
        ...
        <p style="text-align: center; font-size: 18px; color: #3e5f4e;">How much does this video represent <strong>emoji2</strong>?</p>
        ...
        <p style="text-align: center; font-size: 18px; color: #3e5f4e; margin-top:40px;">How much does this video represent <strong>emoji1</strong>?</p>
